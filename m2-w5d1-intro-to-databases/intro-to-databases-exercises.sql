...
SELECT name, continent, headofstate FROM country WHERE governmentform LIKE '%Monarch%';
...
SELECT * FROM city WHERE population > 1000000 AND district='Texas';
...
SELECT name, continent, gnp, lifeexpectancy FROM country WHERE lifeexpectancy > 70 AND gnp > .99 AND gnp < 101;
