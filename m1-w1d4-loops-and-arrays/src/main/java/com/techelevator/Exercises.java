...
public class Exercises {
	...
	public boolean firstLast6(int[] nums) {
		boolean firstIsSix = nums[0] == 6;
		boolean lastIsSix = nums[nums.length-1] == 6;
		
		return firstIsSix || lastIsSix;
	}
	...
	public boolean commonEnd(int[] a, int[] b) {
		boolean firstElement = a[0] == b[0];
		boolean lastElement = a[a.length-1] == b[b.length-1];
	...
	public boolean lucky13(int[] nums) {
		boolean is1or3 = false;
		for(int i = 0; i < nums.length; i++){
			is1or3 = nums[i] == 1 || nums[i] == 3;
			if (is1or3) {
				break;
			}
		}
